...
public class MakeService {
    ...
    public Long saveMake(MakeDTO makeDTO) throws Exception {
        // 상품 등록
        MakeEntity makeEntity=new MakeEntity(makeDTO.getStudyName(), makeDTO.getPhoneNumber(), makeDTO.getEmail(), makeDTO.getPost(), makeDTO.getPersons(), makeDTO.getProgressMethod(), makeDTO.getCloseDate());
